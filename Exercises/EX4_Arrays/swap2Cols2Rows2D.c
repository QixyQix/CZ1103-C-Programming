...
Write a C program to test the above functions. 
In addition, your program should print the resultant matrix after each operation. 
You may assume that the input matrix is a 3x3 matrix when testing the functions.
*/
#include <stdio.h>
#define SIZE 3
void swap2Rows(int ar[][SIZE], int r1, int r2);
